{% macro MultiColumnEdit(relation, columnNames, expressionToBeApplied, prefixSuffixToBeAdded='', changeOutputFieldName=false, isPrefix=true, changeOutputFieldType=false, castOutputTypeName='', copyOriginalColumns=false, remainingColumns=[], prefixSuffixOption = 'prefix / suffix', dataType = 'String') %}
