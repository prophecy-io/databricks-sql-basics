...
class DataTiling(MacroSpec):
    ...
    @dataclass(frozen=True)
    class DataTilingProperties(MacroProperties):
    ...
    def validate(self, context: SqlContext, component: Component) -> List[Diagnostic]:
        ...
        diagnostics = super(DataTiling, self).validate(context, component)
    ...
    def apply(self, props: DataTilingProperties) -> str:
    ...
    def loadProperties(self, properties: MacroProperties) -> PropertiesType:
        ...
        return DataTiling.DataTilingProperties(
